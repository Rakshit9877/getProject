            ...
            <div className="space-y-4">
                ...
                <div className="bg-navy-900/50 border border-white/10 rounded-xl p-5">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                        ...
                        <div><span className="text-navy-500">University</span><p className="text-white font-medium">{formData.university}</p></div>
                        <div><span className="text-navy-500">Year</span><p className="text-white font-medium">{formData.yearOfStudy}</p></div>
                    </div>
                </div>
                ...
                <div className="bg-navy-900/50 border border-white/10 rounded-xl p-5">
                    ...
                    <div className="space-y-3 text-sm">
                        ...
                        {features.length > 0 && (
                            <div>
                                <span className="text-navy-500">Selected Features</span>
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <div className="flex items-baseline gap-2">
                                ...
                                {coupon && price !== finalPrice && <p className="text-lg text-navy-500 line-through">₹{price?.toLocaleString('en-IN')}</p>}
                            </div>
                        </div>
                ...
                <p className="text-center text-xs text-navy-500">Powered by Razorpay • Secure payment gateway</p>
            </div>
        </div>
    )
}
